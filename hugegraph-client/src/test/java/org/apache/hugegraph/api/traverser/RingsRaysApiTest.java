...
public class RingsRaysApiTest extends TraverserApiTest {
    ...
    public void testRings() {
        ...
        PathWithMeasure res = ringsAPI.get(markoId, Direction.BOTH, null,
                                           2, false, -1L, -1L, -1L);
    ...
    public void testRingsWithDepth() {
        ...
        res = ringsAPI.get(markoId, Direction.BOTH, null,
                             2, false, -1L, -1L, -1L);
        paths = res.getRings();
        Assert.assertEquals(0, paths.size());
    ...
    public void testRingsSourceInRing() {
        PathWithMeasure res = ringsAPI.get(1, Direction.BOTH, null,
                                        3, true, -1L, -1L, -1L);
        List<Path> paths = res.getRings();
        Assert.assertEquals(1, paths.size());
        ...
        res = ringsAPI.get(2, Direction.OUT, null,
                             2, true, -1L, -1L, -1L);
        paths = res.getRings();
        Assert.assertEquals(1, paths.size());
        ...
        res = ringsAPI.get(2, Direction.BOTH, null,
                             2, true, -1L, -1L, -1L);
        paths = res.getRings();
        Assert.assertEquals(1, paths.size());
        Assert.assertEquals(path3, paths.get(0).objects());
