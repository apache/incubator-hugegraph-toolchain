...
sed -i "s/#rpc.server_host=127.0.0.1/rpc.server_host=127.0.0.1/g" "$REST_SERVER_CONFIG"
sed -i "s/#rpc.server_timeout=30/rpc.server_timeout=30/g" "$REST_SERVER_CONFIG"
