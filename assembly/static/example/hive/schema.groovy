...
schema.vertexLabel("person").useCustomizeNumberId().properties("name", "age", "city").nullableKeys("age", "city").create();
schema.vertexLabel("software").useCustomizeNumberId().properties("name", "lang", "price").create();
