...
public class LoginUtil {
    ...
    private static final String JAVA_SECURITY_KRB5_CONF_KEY =
    ...
    private static void checkPrincipalAndKeytab(
            boolean checkPrincipal, boolean checkKeytab,
            String loginContextName,
    ...
    private static boolean checkJaasConfParams(
            String loginContextName,
            String principal, String keytabFile) {
    ...
    private static void loginHadoop(String principal,
                                    String keytabFile) throws IOException {
        try {
    ...
    private static boolean checkCurrentUserCorrect(
            String principalParams) throws Exception {
    ...
    /**
     * copy from hbase zkutil 0.94&0.98 A JAAS configuration
     * that defines the login modules that we want to use for
     * login.
     */
