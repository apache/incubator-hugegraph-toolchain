 ...
 *
 */
public class HiveLoadTest extends LoadTest {

    // JDBC driver name and database URL
    private static final String DRIVER = "org.apache.hive.jdbc.HiveDriver";
    private static final String DATABASE = "graph";
    private static final String DB_URL = "jdbc:hive2://127.0.0.1:10000";
...
//    @BeforeClass
    public static void setUp() {
        ...
        dbUtil.execute("CREATE TABLE IF NOT EXISTS `person` (" +
                       ...
                       "`age` int ," +
                       "`city` string ," +
                       "PRIMARY KEY  (`id`) DISABLE NOVALIDATE NORELY" +
                       ")");
        // vertex software
...
//    @Test
    public void testCustomizedSchema() {
        ...
        String[] args = new String[]{
                ...
                "-s", configPath("jdbc_hive_schema/schema.groovy"),
                "-g", GRAPH,
                "-h", SERVER,
...
//    @Test
    public void testValueMappingInJDBCSource() {
        ...
        String[] args = new String[]{
                "-f", configPath("jdbc_hive_value_mapping/struct.json"),
                "-s", configPath("jdbc_hive_value_mapping/schema.groovy"),
                "-g", GRAPH,
                "-h", SERVER,
                "--batch-insert-threads", "2",
                "--test-mode", "true"
