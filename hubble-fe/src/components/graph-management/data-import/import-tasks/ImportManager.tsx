...
import { isEmpty, size, isNull } from 'lodash-es';
        ...
        <div className="import-manager-content-wrapper">
          <div className="import-manager-content-header">
            ...
            <Button
              ...
              style={styles.button}
              disabled={
                isLoading || size(importManagerStore.importJobList) >= 500
              }
              onClick={() => {
              ...
              pagination={
                isLoading
                  ...
                  : {
                      ...
                      pageNo:
                        importManagerStore.importJobListPageConfig.pageNumber,
                      pageSize: 10,
                      showSizeChange: false,
                      showPageJumper: false,
                      total:
                        importManagerStore.importJobListPageConfig.pageTotal,
            ...
            footer={[
              <Button
                ...
                disabled={
                  ...
                  !isEmpty(
                    importManagerStore.validateNewJobErrorMessage.name
                  ) ||
                  !isEmpty(
                ...
                onClick={async () => {
                  ...
                  if (
                    importManagerStore.requestStatus.createNewJob === 'success'
                  ) {
                    Message.success({
                  ...
                  if (
                    importManagerStore.requestStatus.createNewJob === 'failed'
                  ) {
                    Message.error({
                      content:
                        importManagerStore.errorInfo.createNewJob.message,
                      size: 'medium',
                      showCloseIcon: false
                    });
                  }
            ...
            <div>
              <div className="import-manager-create-job-option">
                ...
                <Input
                  ...
                  countMode="en"
                  placeholder={t(
                    'import-manager.placeholder.input-valid-job-name'
                  )}
                  errorLocation="layer"
                  errorMessage={
                    importManagerStore.validateNewJobErrorMessage.name
...
export const ImportManagerManipulation: React.FC<ImportManagerManipulationProps> = observer(
  ({ jobId, jobName, status }) => {
    ...
    const jumpToLoaction = (step: number, jobName: string) => async () => {
      ...
      setLocation(
        `/graph-management/${params!.id}/data-import/${jobId}/import-tasks`
      );
    };
          ...
          <span
            onClick={() => {
              setLocation(
                `/graph-management/${
                  params!.id
                }/data-import/import-manager/${jobId}/error-log`
              );
            }}
          >
